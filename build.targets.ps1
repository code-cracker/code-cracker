Properties {
    ...
    $nugetExe = "$packagesDir\NuGet.CommandLine.2.8.2\tools\NuGet.exe"
    ...
    $openCoverExe = "$packagesDir\OpenCover.4.5.3809-rc94\OpenCover.Console.exe"
    ...
    $reportGeneratorExe = "$packagesDir\ReportGenerator.2.1.3.0\ReportGenerator.exe"
    $coverageReportDir = "$logDir\codecoverage\"
    $converallsNetExe = "$packagesDir\coveralls.io.1.3.2\tools\coveralls.net.exe"
