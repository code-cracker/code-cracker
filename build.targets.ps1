Properties {
    ...
    $openCoverExe = "$packagesDir\OpenCover.4.5.4107-rc122\OpenCover.Console.exe"
    ...
    $reportGeneratorExe = "$packagesDir\ReportGenerator.2.1.7-beta2\tools\ReportGenerator.exe"
