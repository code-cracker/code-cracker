...
namespace CodeCracker
{
    ...
    public class DirectEventInvocationAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "CC0016";
        internal const string Title = "Direct Event Invocation";
        internal const string MessageFormat = "Copy the '{0}' event to a variable before invoke it.";
