...
namespace CodeCracker
{
    ...
    {
        public static bool IsGenerated(this SyntaxNodeAnalysisContext context) => context.SemanticModel.SyntaxTree.IsGenerated() || context.Node.IsGenerated();

        public static bool IsGenerated(this SyntaxTreeAnalysisContext context) => context.Tree.IsGenerated();
        ...
        public static bool IsGenerated(this SyntaxNode node) => node.HasAttributeOnAncestorOrSelf("DebuggerNonUserCode") || node.HasAttributeOnAncestorOrSelf("GeneratedCode");

        public static bool IsGenerated(this SyntaxTree tree) => tree.FilePath.IsOnGeneratedFile() || tree.HasAutoGeneratedComment();
