...
<ExportCodeFixProvider("CodeCrackerMakeLocalVariableConstWhenItIsPossibleCodeFixProvider", LanguageNames.VisualBasic)>
<[Shared]>
Public Class MakeLocalVariableConstWhenPossibleCodeFixProvider
    ...
    Public Overrides Function GetFixableDiagnosticIds() As ImmutableArray(Of String)
        Return ImmutableArray.Create(PerformanceDiagnostics.MakeLocalVariableConstWhenPossibleId)
    End Function
