...
<ExportCodeFixProvider("CodeCrackerRemoveWhereWhenItIsPossibleCodeFixProvider", LanguageNames.VisualBasic)>
<[Shared]>
Public Class RemoveWhereWhenItIsPossibleCodeFixProvider
    ...
    Public Overrides Function GetFixableDiagnosticIds() As ImmutableArray(Of String)
        Return ImmutableArray.Create(PerformanceDiagnostics.RemoveWhereWhenItIsPossibleId)
    End Function
