...
Namespace Design
    ...
    Public Class StaticConstructorExceptionAnalyzer
        ...
        Public Const Description As String = "Static constructors are called before a class is used for the first time. Exceptions thrown in static constructors force the use of a try block and should be avoided."
