...
namespace CodeCracker.Test
{
    public class ConvertLambdaExpressionToMethodGroupTests
        : CodeFixTest<ConvertLambdaExpressionToMethodGroupAnalizer, ConvertLambdaExpressionToMethodGroupFixProvider>
    {
        [Fact]
        public async Task CreateDiagnosticForSimpleLambdaExpression()
        {
            ...
            {
                Id = ConvertLambdaExpressionToMethodGroupAnalizer.DiagnosticId,
